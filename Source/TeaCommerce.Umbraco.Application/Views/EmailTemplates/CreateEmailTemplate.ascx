<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateEmailTemplate.ascx.cs"
  Inherits="TeaCommerce.Umbraco.Application.Views.EmailTemplates.CreateEmailTemplate" %>
