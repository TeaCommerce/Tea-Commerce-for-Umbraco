<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateCurrency.ascx.cs"
  Inherits="TeaCommerce.Umbraco.Application.Views.Currencies.CreateCurrency" %>
...
<div style="margin-top: 20px;">
  ...
  <div style="margin-top: 10px;">
    <asp:Literal ID="LitCultureName" runat="server" />:<br />
    <tc:CultureCodeSelector ID="CultureCodeSelectorControl" runat="server" CssClass="bigInput"
      Width="350px" />
  </div>
