<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateShippingMethod.ascx.cs"
  Inherits="TeaCommerce.Umbraco.Application.Views.ShippingMethods.CreateShippingMethod" %>
