<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateCountryRegion.ascx.cs"
  Inherits="TeaCommerce.Umbraco.Application.Views.CountryRegions.CreateCountryRegion" %>
