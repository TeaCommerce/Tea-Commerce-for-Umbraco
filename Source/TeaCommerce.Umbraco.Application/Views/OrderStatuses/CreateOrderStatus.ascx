<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateOrderStatus.ascx.cs"
  Inherits="TeaCommerce.Umbraco.Application.Views.OrderStatuses.CreateOrderStatus" %>
